	...
	<div style="border:solid 1px #ccc; border-radius:1px; padding:1rem;">
		<div style="display:flex; justify-content:space-between; border-bottom:dotted 1px #ccc; padding-bottom: 0.2rem;">
			<div style="width:70%; font-size:1.25rem; font-weight:bold;">
				<span data-duice="Text" data-duice-bind="article.title" style="font-size:inherit;"></span>
			</div>
		...
		<div style="display:flex; justify-content:space-between;">
			<div>
				...
				(<span data-duice="Text" data-duice-bind="article.userId"></span>)
			</div>
		...
		<div style="min-height:50rem;">
			<pre data-duice="Text" data-duice-bind="article.contents"></pre>
		</div>
			...
			<div style="text-align:right;">
				<ul data-duice="ListView" data-duice-bind="files" data-duice-item="file">
					<li>
						...
						(<Label data-duice="Text" data-duice-bind="file.size" data-duice-format="number:0"></Label>)
						bytes
		...
		<div>
			<ul data-duice="ListView" data-duice-bind="replies" data-duice-item="reply" style="padding:0.5rem;">
				<li style="margin:0.5rem; padding-left:[[$context.reply.get('indent')*2]]rem;">
					<div style="border-bottom: dotted 1px #ccc;">
						<div style="display:flex; justify-content:space-between;">
							<div>
								<i class="icon-level-down"></i>
								id:<span data-duice="Text" data-duice-bind="reply.id"></span>
								|
								upperNo:<span data-duice="Text" data-duice-bind="reply.upperNo"></span>
								|
								sequence:<span data-duice="Text" data-duice-bind="reply.sequence"></span>
								|
								level:<span data-duice="Text" data-duice-bind="reply.level"></span>
						...
						<div id="app-board-reply-container-modify-[[$context.reply.get('id')]]">
							<pre data-duice="Text" data-duice-bind="reply.contents"></pre>
						</div>
		...
		<div id="app-board-reply-container" style="padding:1rem;">
			<div id="app-board-reply-editor">
				...
				<div>
					<textarea data-duice="TextArea" data-duice-bind="reply.contents" style="height:20rem;"></textarea>
				</div>
				<div style="text-align:right;">
