...
public class PageableInterceptor2 implements Interceptor {
	
	enum DatabaseId { ANSI, ORACLE, MYSQL, POSTRES, MSSQL }
	
	private static final Logger LOGGER = LoggerFactory.getLogger(PageableInterceptor2.class);
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		//Object obj = metaObject.getValue("delegate.rowBounds");
	...
	private void setTotalCount(final MetaObject metaObject, final PageableRowBounds pageableRowBounds, Configuration configuration, DatabaseId databaseId) throws SQLException {
		...
		MappedStatement.Builder builder = new MappedStatement.Builder(configuration, mappedStatement.getId(), totalCountSqlSource, mappedStatement.getSqlCommandType());
		...
		ResultMap.Builder resultMapBuilder = new ResultMap.Builder(configuration, mappedStatement.getId(), Integer.class, resultMappings);
