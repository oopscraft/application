...
import net.oopscraft.application.utility.restclient.example.ExampleClient;
			...
			public void actionPerformed(ActionEvent evt) { 
				try { 
					...
					if(testTextArea.getText() != null) { 
						params = JsonConverter.toObject(testTextArea.getText(), ValueMap.class); 
					} 
					resultTextArea.setText(""); 
					...
					if(response instanceof Object) {
						result = JsonConverter.toJson(response);
					}else {
