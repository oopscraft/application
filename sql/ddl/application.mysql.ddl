...
CREATE TABLE APP_PAGE_INFO(
		PAGE_ID                       		VARCHAR(32)		 NOT NULL COMMENT 'Page ID',
		PAGE_NAME                     		VARCHAR(256)		 NULL COMMENT 'Page Name' ,
		PAGE_TYPE                     		VARCHAR(16)		 NULL COMMENT 'Page Type' ,
		PAGE_VAL                      		VARCHAR(4000)		 NULL COMMENT 'Page Value' ,
		ACES_PLCY                     		VARCHAR(128)		 NULL COMMENT 'Access Policy' 
);

ALTER TABLE APP_PAGE_INFO comment 'Applicaton Page Info';
/* Moved to CREATE TABLE
...
ALTER TABLE APP_PAGE_PLCY_AUTH_MAP comment 'Application Page Policy Authority Map';
/* Moved to CREATE TABLE
